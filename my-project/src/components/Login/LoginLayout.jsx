  ...
  const handleLogin = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://keluh-dev.mdrizki.my.id/api/v1/admins/login",
        {
    ...
    <div className="h-svh grid place-items-center md:flex md:flex-row py-6 px-6 md:px-0 md:py-0">
      <div className="hidden w-6/12 h-full bg-main-color justify-between md:flex flex-col">
        ...
        <img
          src={menara}
          alt="menara image"
          className="mb-0 w-60 h-72 xl:h-96 xl:w-72"
        />
      </div>
      <div className="flex flex-col h-auto py-5 px-3 lg:h-full bg-white rounded-md lg:rounded-none w-full lg:w-6/12 lg:justify-center lg:gap-14 lg:px-28">
        <h2 className="text-wrap mx-auto text-main-color text-2xl text-center mb-3 lg:mb-0 md:text-4xl font-bold font-poppins leading-10">
          Selamat datang Admin !
        </h2>
        <h3 className="text-center text-gray-500 text-base lg:text-xl mb-4 lg:mb-0 font-bold font-poppins leading-relaxed">
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex flex-col gap-2.5 mb-2.5">
            <label
              htmlFor="email"
              className="text-zinc-900 text-base font-medium font-poppins leading-tight"
            >
              Email
            </label>
            <input
              ...
              type="email"
              id="email"
              className={`px-5 py-3 rounded-md w-full text-black placeholder:text-gray-400 text-base font-normal font-poppins leading-normal ${
                errorLogin
                  ? "text-error-3 border border-error-3"
          ...
          <div className="flex flex-col gap-2.5 mb-2.5 w-full">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`rounded-md w-full text-black placeholder:text-gray-400 text-base font-normal font-poppins leading-normal ps-5 pe-9 py-3 ${
                  errorLogin
                    ? "text-error-3 border border-error-3"
                    : "border border-main-color"
                }`}
          ...
          <button
            type="submit"
            className=" bg-main-color w-full px-6 mt-5 mb-3 lg:mb-0 lg:mt-8 py-2.5 justify-center items-center inline-flex rounded-md shadow-lg hover:bg-main-darker "
          >
            <span className="text-center text-zinc-900 text-sm font-medium font-poppins">
              Login
            </span>
          </button>
        </form>
