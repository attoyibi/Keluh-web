...
export default function Hero() {
  return (
    <div
      className="h-[670px] sm:h-[800px] bg-main-darker flex flex-col md:flex-row justify-between lg:ps-20 relative"
      id="home"
    >
      {/* Background SVG */}
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <feGaussianBlur
                stdDeviation="50"
                result="effect1_foregroundBlur_302_833"
              />
            </filter>
          </defs>
        </svg>
      ...
      <div className="relative flex flex-col px-8 py-6 md:flex-row justify-start items-center md:w-[578px] gap-44">
        <div className="flex flex-col">
          <img
            className="h-7 w-36  md:w-96 md:h-20 mb-7"
            src={logo}
            alt="KeluhProv Logo"
          />
          <div className="text-justify text-zinc-900 text-sm md:text-xl font-semibold font-['Montserrat'] leading-normal">
            KeluhProv adalah aplikasi untuk melaporkan keluhan masyarakat.
            Dengan antarmuka yang mudah digunakan, penduduk bisa dengan cepat
            mengirimkan keluhan mereka tentang infrastruktur, layanan publik,
            atau masalah lingkungan. Aplikasi ini memudahkan pelacakan status
            keluhan dan membantu pemerintah memperbaiki layanan publik.
          </div>
      ...
      <div className="relative mb-0 mt-auto flex justify-center">
        <img
          src={iphoneImage}
          alt="image"
          className="w-auto h-[300px] lg:w-[568px] lg:h-[615px]"
        />
      </div>
    </div>
  );
